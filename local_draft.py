...
from config import OPENAI_API_KEY, PERFORMANCE_CONFIG
import logging
import time
import threading
...
### =================== Text Processing =================== ###
class TextProcessor:
    def __init__(self, chunk_size: int = 1000, overlap: int = 50):  # Reduced chunk size, increased overlap
        ...
        self.max_image_size_mb = 10  # Reduced from 25MB
        self.image_dpi = 120  # Reduced from 150 for faster processing
        self.batch_size = 100  # For embedding batching
...
class WebFileHandler:
    def __init__(self):
        ...
        self.executor = ThreadPoolExecutor(max_workers=4)  # Increased from 3 for better parallelization
...
class VectorStore:
    def __init__(self, dimension: int = 768):
        ...
        self.max_documents_before_rebuild = 1000  # Rebuild index periodically
